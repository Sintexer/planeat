...
Present-tense product behavior as of Sprint 29. Remaining sequenced work is Phase 7 (automatic meal planning) in [`docs/sprints/generation.md`](sprints/generation.md); Status in [`docs/sprints/plan.md`](sprints/plan.md).
